define([
  ...
  */
    ...
    iframeLoaded: function() {
      console.log('detecting iframe loaded');
      var iFrameID = document.getElementById('idIframe');
      var dijitDiv = document.getElementById('dijit_layout_ContentPane_9');
      if (iFrameID && dijitDiv) {
        console.log('fix height please');
        console.log(dijitDiv);
        console.log(iFrameID);
        console.log(iFrameID.contentWindow);
        //iFrameID.height = '';
        dijitDiv.style.height = iFrameID.style.height;
        dijitDiv.style.cssText += 'overflow:hidden';
        //document.getElementById('dijit_layout_ContentPane_5').style.overflowY = 'hidden';
      }
    },
    uploadJobsWidget: function(action) {
      if (action === 'show') {
        console.log('I want to see the upload and jobs widget');
        var wsc = new WorkspaceController({
          region: 'bottom'
        });
